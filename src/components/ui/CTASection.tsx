    ...
    <section ref={sectionRef} className="py-32 md:py-48 relative bg-void">
      <div className="relative max-w-4xl mx-auto px-6 md:px-10 text-center">
        <div className="cta-content">
          <h2 className="font-display text-[clamp(1.75rem,7vw,5rem)] md:text-5xl lg:text-6xl font-bold tracking-[-0.03em] leading-[1.05] uppercase text-cream">
          ...
          <div className="mt-10">
            <a
              ...
              className="relative inline-flex items-center justify-center min-h-[44px] font-mono text-[10px] tracking-[0.25em] uppercase px-8 py-4 border border-signal text-signal hover:bg-signal hover:text-void transition-colors duration-200"
            >
